...
const steps = [
    ...
    },
    {
        ...
        name: 'gender',
        options: [
            { value: '남자', label: 'male', image: 'https://journey-han.github.io/asset/img/Boy.png' },
            { value: '여자', label: 'female', image: 'https://journey-han.github.io/asset/img/Girl.png' }
        ]
    },
    {
        type: 'radio',
    ...
    },
    {
        ...
        name: 'lifeStyle',
        options: [
            { value: '게으른', label: 'Lazy', image: 'https://journey-han.github.io/asset/img/Lazy.png' },
            { value: '활동적인', label: 'Active', image: 'https://journey-han.github.io/asset/img/Active.png' },
            { value: '매우 활동적인', label: 'Very Active', image: 'https://journey-han.github.io/asset/img/Very_Active.png' }
        ]
    },
    {
        type: 'radio',
        ...
        name: 'bodyType',
        options: [
            { value: '조금 마른', label: 'A little skinny', image: 'https://journey-han.github.io/asset/img/A_little_skinny.png' },
            { value: '적당한', label: 'Just right', image: 'https://journey-han.github.io/asset/img/Just_right.png' },
            { value: '과체중', label: 'A little chubby', image: 'https://journey-han.github.io/asset/img/A_little_chubby.png' },
            { value: '비만', label: 'Obese', image: 'https://journey-han.github.io/asset/img/Obese.png' }
        ]
    },
    {
        type: 'radio',
...
function renderResults() {
    ...
    Object.keys(formData).forEach(key => {
        ...
        const images = [
            { src: 'https://journey-han.github.io/asset/img/result_pork.png', alt: 'result_pork', url: 'https://popone.kr/729973229/?idx=48' },
            { src: 'https://journey-han.github.io/asset/img/result_beef.png', alt: 'result_beef', url: 'https://popone.kr/729973229/?idx=49' },
            { src: 'https://journey-han.github.io/asset/img/result_chicken.png', alt: 'result_chicken', url: 'https://popone.kr/729973229/?idx=50' },
            { src: 'https://journey-han.github.io/asset/img/result_duck.png', alt: 'result_duck', url: 'https://popone.kr/729973229/?idx=51' },
            { src: 'https://journey-han.github.io/asset/img/result_lamb.png', alt: 'result_lamb', url: 'https://popone.kr/729973229/?idx=52' },
            { src: 'https://journey-han.github.io/asset/img/result_horse.png', alt: 'result_horse', url: 'https://popone.kr/729973229/?idx=53' },
            { src: 'https://journey-han.github.io/asset/img/result_fish.png', alt: 'result_fish', url: 'https://popone.kr/729973229/?idx=54' }
        ];
        ...
        if (key === 'allergy') {
            ...
            const additionalImages = value.flatMap(value => {
                if (value === '돼지') {
                    return { src: 'https://journey-han.github.io/asset/img/result_pork.png', alt: 'result_pork', url: 'https://popone.kr/729973229/?idx=48' };
                } else if (value === '소') {
                    return { src: 'https://journey-han.github.io/asset/img/result_beef.png', alt: 'result_beef', url: 'https://popone.kr/729973229/?idx=49' };
                } else if (value === '닭' || value === '칠면조') {
                    return { src: 'https://journey-han.github.io/asset/img/result_chicken.png', alt: 'result_chicken', url: 'https://popone.kr/729973229/?idx=50' };
                } else if (value === '오리') {
                    return { src: 'https://journey-han.github.io/asset/img/result_duck.png', alt: 'result_duck', url: 'https://popone.kr/729973229/?idx=51' };
                } else if (value === '양') {
                    return { src: 'https://journey-han.github.io/asset/img/result_lamb.png', alt: 'result_lamb', url: 'https://popone.kr/729973229/?idx=52' };
                } else if (value === '말') {
                    return { src: 'https://journey-han.github.io/asset/img/result_horse.png', alt: 'result_horse', url: 'https://popone.kr/729973229/?idx=53' };
                } else if (value === '흰살생선' || value === '연어') {
                    return { src: 'https://journey-han.github.io/asset/img/result_fish.png', alt: 'result_fish', url: 'https://popone.kr/729973229/?idx=54' };
                } else {
                    return [];
                }
            });
        ...
        <div class="swiper-slide">
            <div class="re_img">
                ...
                <a href="${image.url}" target="blank"><img src="https://journey-han.github.io/asset/img/buyButton.png" id="buyButton"></a>
                </br>
            </div>
        </div>
    `).join('');
    ...
    */
    ...
    link.rel = 'stylesheet';
    link.href = 'https://journey-han.github.io/asset/css/swiper.css';
    document.head.appendChild(link);

    const script = document.createElement('script');
    script.src = "https://journey-han.github.io/asset/js/swiper.min.js";
...
async function fetchProducts() {
    try {
        const response = await fetch('https://journey-han.github.io/asset/json/productsSnack.json');
        if (!response.ok) {
