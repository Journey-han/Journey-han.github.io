...
const steps = [
    ...
    },
    {
        ...
        name: 'gender',
        options: [
            { value: '남자', label: 'male', image: '/assets/img/Boy.png' },
            { value: '여자', label: 'female', image: '/assets/img/Girl.png' }
        ]
    },
    {
        type: 'radio',
    ...
    },
    {
        ...
        name: 'lifeStyle',
        options: [
            { value: '게으른', label: 'Lazy', image: '/assets/img/Lazy.png' },
            { value: '활동적인', label: 'Active', image: '/assets/img/Active.png' },
            { value: '매우 활동적인', label: 'Very Active', image: '/assets/img/Very_Active.png' }
        ]
    },
    {
        type: 'radio',
        ...
        name: 'bodyType',
        options: [
            { value: '조금 마른', label: 'A little skinny', image: '/assets/img/A_little_skinny.png' },
            { value: '적당한', label: 'Just right', image: '/assets/img/Just_right.png' },
            { value: '과체중', label: 'A little chubby', image: '/assets/img/A_little_chubby.png' },
            { value: '비만', label: 'Obese', image: '/assets/img/Obese.png' }
        ]
    },
    {
        type: 'radio',
...
function renderResults() {
    ...
    Object.keys(formData).forEach(key => {
        ...
        const images = [
            { src: '/assets/img/result_pork.png', alt: 'result_pork', url: 'https://popone.kr/729973229/?idx=48' },
            { src: '/assets/img/result_beef.png', alt: 'result_beef', url: 'https://popone.kr/729973229/?idx=49' },
            { src: '/assets/img/result_chicken.png', alt: 'result_chicken', url: 'https://popone.kr/729973229/?idx=50' },
            { src: '/assets/img/result_duck.png', alt: 'result_duck', url: 'https://popone.kr/729973229/?idx=51' },
            { src: '/assets/img/result_lamb.png', alt: 'result_lamb', url: 'https://popone.kr/729973229/?idx=52' },
            { src: '/assets/img/result_horse.png', alt: 'result_horse', url: 'https://popone.kr/729973229/?idx=53' },
            { src: '/assets/img/result_fish.png', alt: 'result_fish', url: 'https://popone.kr/729973229/?idx=54' }
        ];
        ...
        if (key === 'allergy') {
            ...
            const additionalImages = value.flatMap(value => {
                if (value === '돼지') {
                    return { src: '/assets/img/result_pork.png', alt: 'result_pork', url: 'https://popone.kr/729973229/?idx=48' };
                } else if (value === '소') {
                    return { src: '/assets/img/result_beef.png', alt: 'result_beef', url: 'https://popone.kr/729973229/?idx=49' };
                } else if (value === '닭' || value === '칠면조') {
                    return { src: '/assets/img/result_chicken.png', alt: 'result_chicken', url: 'https://popone.kr/729973229/?idx=50' };
                } else if (value === '오리') {
                    return { src: '/assets/img/result_duck.png', alt: 'result_duck', url: 'https://popone.kr/729973229/?idx=51' };
                } else if (value === '양') {
                    return { src: '/assets/img/result_lamb.png', alt: 'result_lamb', url: 'https://popone.kr/729973229/?idx=52' };
                } else if (value === '말') {
                    return { src: '/assets/img/result_horse.png', alt: 'result_horse', url: 'https://popone.kr/729973229/?idx=53' };
                } else if (value === '흰살생선' || value === '연어') {
                    return { src: '/assets/img/result_fish.png', alt: 'result_fish', url: 'https://popone.kr/729973229/?idx=54' };
                } else {
                    return [];
                }
            });
        ...
        <div class="swiper-slide">
            <div class="re_img">
                ...
                <a href="${image.url}" target="blank"><img src="/assets/img/buyButton.png" id="buyButton"></a>
                </br>
            </div>
        </div>
    `).join('');
    ...
    */
    ...
    link.rel = 'stylesheet';
    link.href = '/assets/css/swiper.css';
...
async function fetchProducts() {
    try {
        const response = await fetch('/assets/json/productsSnack.json');
        if (!response.ok) {
